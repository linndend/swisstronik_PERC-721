...
async function main() {
  ...
  const contract = await hre.ethers.deployContract("Lindend", [JAN_1ST_2030], {
    value: ONE_GWEI,
  });
  ...
  try {
    ...
    console.log("Contract verified to", hre.config.etherscan.customChains[0].urls.browserURL + "0x514953B067427157Ae1Dc52472314867d35C5515" + contract.target);
  } catch (err) {
